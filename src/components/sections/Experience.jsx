...
const ITEMS = [
  ...
  },
  {
    ...
    role: "Population Health Minor",
    org: "University of Houston",
    desc: "Coursework in population health, health informatics, population informatics, healthcare data, and health analytics. Developing analytical skills to interpret health data and understand how digital systems can support better health outcomes at scale.",
    tag: "Education",
  },
  {
    when: "2025 — Present",
    // TODO: use ONE consistent title across resume, portfolio, and LinkedIn (your resume currently says "Student Technology Assistant").
    role: "Student Library Assistant",
    org: "University of Houston — MD Anderson Library",
    desc: "Support daily library operations serving thousands of students each week, manage circulation records, troubleshoot account discrepancies, and assist patrons with university resources while maintaining accuracy and consistent service quality.",
    tag: "Part-time",
